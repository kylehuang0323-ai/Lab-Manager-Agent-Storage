...
12. **create_asset** — 新建资产
    参数: {"name": "资产名", "category": "分类", "serial_number": "", "model": "", "custodian": "", "building": "", "room": "", "location_detail": "", "notes": ""}

13. **assign_asset** — 分配资产给用户
    参数: {"asset_id": "AST-0001", "to_person": "使用人", "operator": "操作人", "note": ""}

14. **return_asset** — 归还资产
    参数: {"asset_id": "AST-0001", "operator": "操作人", "note": ""}

15. **transfer_asset** — 转移资产
    参数: {"asset_id": "AST-0001", "to_person": "新使用人", "operator": "操作人", "note": ""}

16. **dispose_asset** — 报废资产
    参数: {"asset_id": "AST-0001", "operator": "操作人", "note": "报废原因"}

17. **query_asset** — 查询资产（单个或全部）
    参数: {"asset_id": "AST-0001"} 或 {} 表示查全部
...
- 如果用户提到资产名但没给 asset_id，先用 search_assets 搜索
