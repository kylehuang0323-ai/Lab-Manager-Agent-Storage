...
const I18N = {
    zh: {
        ...
        lblBuilding: '楼宇',
        lblRoom: '房间',
        lblLocationDetail: '位置详情',
        lblStartDate: '启用日期',
        lblDisposeDate: '报废日期',
        lblNotes: '备注',
        btnSave: '保存',
        toastUpdateSuccess: '资产已更新',
    ...
    en: {
        ...
        thDisposeDate: 'Dispose Date',
        thAssetAge: 'Asset Age',
        thMapAging: 'MAP Aging',
        ...
        lblRoom: 'Room',
        lblLocationDetail: 'Location Detail',
        lblStartDate: 'Start Date',
        lblDisposeDate: 'Dispose Date',
        lblNotes: 'Notes',
        btnSave: 'Save',
        toastUpdateSuccess: 'Asset updated',
